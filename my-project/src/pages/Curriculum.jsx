      ...
      <section className="py-28 text-center relative overflow-hidden bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900">
        ...
        <div className="relative max-w-6xl mx-auto px-4">
          ...
          <p className="text-slate-400 max-w-3xl mx-auto text-lg">
            Master Frontend Development, Backend Development, Databases,
            Authentication, Real Projects, Mock Interviews and Placement
            Preparation through our structured industry-focused program.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 relative">
          ...
          <div className="space-y-32">
            <WeekBlock
              ...
              days={[
                { text: "HTML5 Fundamentals", type: "rapid" },
                { text: "Semantic Tags", type: "rapid" },
                { text: "Forms & Tables", type: "rapid" },
                { text: "CSS Basics", type: "rapid" },
                { text: "Frontend Mock Assessment", type: "power" },
              ]}
            />
            ...
            <WeekBlock
              ...
              days={[
                { text: "Flexbox & Grid", type: "rapid" },
                { text: "Responsive Design", type: "rapid" },
                { text: "JavaScript ES6+", type: "rapid" },
                { text: "DOM Manipulation", type: "rapid" },
                { text: "JavaScript Mock", type: "power" },
              ]}
            />
            ...
            <WeekBlock
              ...
              days={[
                { text: "React Fundamentals", type: "rapid" },
                { text: "Components & Props", type: "rapid" },
                { text: "Hooks", type: "rapid" },
                { text: "React Router", type: "rapid" },
                { text: "React Interview Mock", type: "power" },
              ]}
            />
            ...
            <WeekBlock
              ...
              days={[
                { text: "Node.js", type: "rapid" },
                { text: "Express.js", type: "rapid" },
                { text: "MongoDB", type: "rapid" },
                { text: "REST APIs", type: "rapid" },
                { text: "Backend Mock", type: "power" },
              ]}
            />
            ...
            <WeekBlock
              ...
              days={[
                { text: "Authentication System", type: "rapid" },
                { text: "Project Deployment", type: "rapid" },
                { text: "Resume Building", type: "rapid" },
                { text: "Placement Strategy", type: "rapid" },
                { text: "Final Full Stack Mock", type: "power" },
              ]}
            />
          </div>
        </div>
...
function CardContent({ week, title, days, align }) {
  return (
    <div className="bg-slate-900/70 backdrop-blur border border-slate-800 rounded-2xl p-10 shadow-2xl hover:shadow-indigo-500/20 hover:-translate-y-2 transition duration-500">
      <div
        className={`text-indigo-400 font-semibold mb-2 tracking-wide uppercase text-sm ${
      ...
      <ul className="space-y-4 text-slate-300">
        {days.map((day, index) => (
          <li key={index} className="flex items-center gap-3">
            ...
            <span className="text-slate-200">{day.text}</span>
          </li>
        ))}
      </ul>
    </div>
